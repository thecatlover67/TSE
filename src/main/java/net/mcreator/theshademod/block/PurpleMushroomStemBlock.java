...
public class PurpleMushroomStemBlock extends TheShadeModModElements.ModElement {
	@ObjectHolder("the_shade_mod:purple_mushroom_stem")
	public static final Block block = null;
	public PurpleMushroomStemBlock(TheShadeModModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STEM).hardnessAndResistance(3f, 10f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("purple_mushroom_stem");
		}
